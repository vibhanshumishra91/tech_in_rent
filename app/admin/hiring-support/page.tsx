...
export default function HiringSupportPage() {
  ...
  const fetchRequests = async () => {
    try {
      const response = await fetch("/api/admin/hiring-support");
  ...
  return (
    <div style={{ padding: "32px", maxWidth: "1400px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        ...
        >
          Manage hiring requests and candidate searches
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <HiUsers size={24} style={{ color: "#6366f1" }} />
            </div>
            <div>
              <h3
                style={{
