      ...
      >
              ...
              >
                ...
                <div
                  style={{
                    ...
                    borderRadius: "20px",
                    background:
                      "linear-gradient(135deg, #067CCB 0%, #0e7a9f 100%)",
                    opacity: 0.1,
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      borderRadius: "12px",
                      background:
                        "linear-gradient(135deg, rgba(6,124,203,0.05) 0%, rgba(14,122,159,0.05) 100%)",
              ...
              {[
                {
                  ...
                  description:
                    "Get immediate access to verified LinkedIn accounts",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "Accounts with thousands of industry-specific connections",
                },
                {
                  title: "Industry-Specific",
                  description:
                    "Target the right audience with specialized accounts",
                },
              ].map((item, index) => (
                <div
                  key={index}
              ...
              {[
                {
                  ...
                  description:
                    "High-quality, verified LinkedIn accounts with established credibility",
                },
                {
                  title: "24/7 Support",
                  description:
                ...
                },
                {
                  ...
                  description:
                    "Thousands of satisfied customers with measurable results",
                },
              ].map((item, index) => (
                <div
                  key={index}
              ...
              {[
                {
                  ...
                  description:
                    "Generate high-quality B2B leads for your sales team",
                },
                {
                  title: "Recruitment",
                  description:
                ...
                },
                {
                  ...
                  description:
                    "Build partnerships and expand your professional network",
                },
                {
                  title: "Market Research",
                  description:
                    "Gather insights and connect with industry professionals",
                },
              ].map((item, index) => (
                <div
                  key={index}
        ...
        >
          ...
          >
            ...
            >
              Choose from our range of account types to match your business
              requirements
            </p>
          ...
          >
            ...
            >
              {[
                {
                  question:
                    "How does the LinkedIn account rental process work?",
                  answer:
                    "We provide you with access to verified LinkedIn accounts. After booking a demo, our team onboards you within 48 hours and sets up the account according to your business needs.",
                },
                {
                  question: "Is it safe to use rented LinkedIn accounts?",
                  answer:
                    "Yes, all our accounts are verified and follow LinkedIn's guidelines. We have a 100% safe track record with less than 5% restriction rate across all managed accounts.",
                },
                {
                  question: "What security measures do you have in place?",
                  answer:
                    "We use industry-standard security protocols, monitor account health daily, and provide immediate support if any issues arise. All accounts come with backup access and recovery support.",
                },
                {
                  question: "Can I modify the LinkedIn profile during rental?",
                  answer:
                    "Yes, within agreed guidelines. You can update the profile picture, headline, and posts. Major changes require approval from our team to maintain account safety.",
                },
                {
                  question:
                    "What happens if there's an issue with my rented account?",
                  answer:
                    "Our support team is available 5 days a week. We provide immediate account recovery support and if needed, replace the account within 24-48 hours at no extra cost.",
                },
              ].map((faq, index) => {
